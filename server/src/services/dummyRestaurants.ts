...
export function generateDummyRestaurants(keywords: string[]): Restaurant[] {
  ...
  const dummies: Restaurant[] = [
    ...
    },
    {
      ...
      websiteUrl: null,
      googleMapsUrl:
        "https://www.google.com/maps/search/?api=1&query=35.6612,139.6983",
    },
    {
      id: uuidv4(),
      ...
      googleMapsUrl:
        "https://www.google.com/maps/search/?api=1&query=35.6578,139.7021",
    },
    {
      id: uuidv4(),
      ...
      websiteUrl: null,
      googleMapsUrl:
        "https://www.google.com/maps/search/?api=1&query=35.6631,139.6972",
    },
    {
      id: uuidv4(),
      ...
      googleMapsUrl:
        "https://www.google.com/maps/search/?api=1&query=35.6521,139.7043",
    },
  ];
